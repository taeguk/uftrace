...
#if __LONG_WIDTH__ != 64 && __LONG_WIDTH__ != 32
# error "long width is not 32 nor 64!"
#endif

/* re-define Elf64_Addr as Elf_Addr */
#define ElfT(name)       ElfT1(__LONG_WIDTH__, name)
...
#define ELF_M(ACT)         ELF_M1(__LONG_WIDTH__, ACT)
